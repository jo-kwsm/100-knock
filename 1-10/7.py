...
def main():
    ...
    print(data["transaction_detail"].isnull().sum())
    print(data["transaction_detail"].describe())
    print(data["transaction_detail"]["payment_date"].min())
    print(data["transaction_detail"]["payment_date"].max())
